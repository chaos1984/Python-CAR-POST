...
####################################################################################
		...
		#
		#QGroupBox
		self.echoGroup =  QtWidgets.QGroupBox('控制窗口')
		...
		#
		#QButton_sort
		self.btn7 = QtWidgets.QPushButton("过滤")
		...
		#QButton_plot
		self.btn8 = QtWidgets.QPushButton("绘图")
...
################################################################################
	...
	def table_insert(self):
		...
		self.dataTable.setItem(row , 1, QtWidgets.QTableWidgetItem(self.time))
	...
	def table_sort(self):
		try:
			if self.des_sort == True:
				...
				self.dataTable.setSortingEnabled(True)  # 设置表头可以自动排序
			else:
				col_select = self.dataTable.selectedItems()
				col = col_select[0].column()
	...
	def buttonForRow(self,id):
		widget=QWidget()
		# 填写
		updateBtn = QtWidgets.QPushButton('填写')
		...
		#安全锁
		lockBtn = QtWidgets.QPushButton('锁')
