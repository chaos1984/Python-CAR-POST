proc DYNA_PAB_FILES {} {
	...
	*createmark mats 2 displayed
	...
	foreach compNum $compNums {	
		...
		*endnotehistorystate {isolateonly Component $compNum}
		if {$compNum < 100} {
		set includeName "05_Cushion_fold"
		set includeNum 1000
		} elseif {$compNum > 99 && $compNum < 200} {
		set start 1000000
		set includeName "08_Inflator"
		set includeNum 1008
		} elseif {$compNum > 199 && $compNum < 300} {
		set start 2000000
		set includeName "09_Cover"
		set includeNum 1009
		} elseif {$compNum > 299 && $compNum < 400} {
		set start 3000000
		set includeName "10_Housing"
		set includeNum 1010
		} elseif {$compNum > 399 && $compNum < 500} {
		set start 4000000
		set includeName "11_Emblem"
		set includeNum 1011
		} elseif {$compNum > 499 && $compNum < 600} {
		set start 5000000
		set includeName "Omega_spring"
		set includeNum 1015
		} elseif {$compNum > 599 && $compNum < 700} {
		set start 6000000
		set includeName "12_SW_amature"
		set includeNum 1012
		} elseif {$compNum > 699 && $compNum < 800} {
		set start 7000000
		set includeName "12_1_SW_form"
		set includeNum 1014
		} elseif {$compNum > 799 && $compNum < 900} {
		set start 8000000
		set includeName "13_Other_parts"
		set includeNum 1013
		} elseif {$compNum > 899} {
		set start 9000000
		set includeName "Unspec"
		set includeNum 1014
		}
        *clearmarkall 1
		*clearmarkall 2
	...
	*createmark cards 1 all
	...
	append includePath 01_Control.key
	...
	*startnotehistorystate {Create Include "ContactCard"}
	append includePath 03_Contact.key
	...
	*startnotehistorystate {Create Include "Sets"}
	append includePath 999_sets.key
	*createinclude 999 999_sets.key $includePath 0
