	...
	*createmarkpanel comps 1 "Select comps to create include";
	...
	foreach compNum $compNums {	
		...
		*endnotehistorystate {isolateonly Component $compNum}
		if {$compNum < 100} {
		set includeName "G000_Cushion_fold"
		set includeNum 1000
		} elseif {$compNum > 99 && $compNum < 200} {
		set start 1000000
		set includeName "G100_Inflator"
		set includeNum 1008
		} elseif {$compNum > 199 && $compNum < 300} {
		set start 2000000
		set includeName "G200_Cover"
		set includeNum 1009
		} elseif {$compNum > 299 && $compNum < 400} {
		set start 3000000
		set includeName "G300_Housing"
		set includeNum 1010
		} elseif {$compNum > 399 && $compNum < 500} {
		set start 4000000
		set includeName "G400_Emblem"
		set includeNum 1011
		} elseif {$compNum > 499 && $compNum < 600} {
		set start 5000000
		set includeName "G500_Omega_spring"
		set includeNum 1012
		} elseif {$compNum > 599 && $compNum < 700} {
		set start 6000000
		set includeName "G600_SW_amature"
		set includeNum 1013
		} elseif {$compNum > 699 && $compNum < 800} {
		set start 7000000
		set includeName "G700_SW_foam"
		set includeNum 1014
		} elseif {$compNum > 799 && $compNum < 900} {
		set start 8000000
		set includeName "G800_Other_parts"
		set includeNum 1015
		} elseif {$compNum > 899 && $compNum < 1000} {
		set start 9000000
		set includeName "G900_RIGID_CONNECT"
		set includeNum 1016
		} 
        *clearmarkall 1
		*clearmarkall 2
		...
		*setvalue comps id=$compNum cardimage="Part"
		*createentity props cardimage=SectShll name=$compNum 
